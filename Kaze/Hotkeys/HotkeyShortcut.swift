...
struct HotkeyShortcut: Codable, Equatable {
    ...
    static let `default` = HotkeyShortcut(modifiers: [.option, .command], keyCode: nil)
    ...
    static func loadFromDefaults(_ defaults: UserDefaults = .standard) -> HotkeyShortcut {
        guard
            let data = defaults.data(forKey: AppPreferenceKey.hotkeyShortcut),
    ...
    func saveToDefaults(_ defaults: UserDefaults = .standard) {
        ...
        defaults.set(data, forKey: AppPreferenceKey.hotkeyShortcut)
    }
